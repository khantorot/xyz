...
document.querySelector('.slogan').onmouseover = function(){
	...
	document.querySelector('.slogan').classList.add('slogan_active');
	document.querySelector('.video-bg').classList.add('video-bg_show');
}
document.querySelector('.slogan').onmouseout = function(){
	document.querySelector('video').pause();
	document.querySelector('.slogan').classList.remove('slogan_active');
	document.querySelector('.video-bg').classList.remove('video-bg_show');
}
