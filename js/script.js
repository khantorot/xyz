...
document.querySelector('.front').onmouseover = function(event){
	if(event.movementX >= 15 && event.movementX >= event.movementY){
		cube.style.transform = 'rotateY(90deg)';
	}else if(event.movementX <= -15 && event.movementX <= event.movementY){
		cube.style.transform = 'rotateY(-90deg)';
	}else if(event.movementY >= 15 && event.movementY >= event.movementX){
...
document.querySelector('.left').onmouseover = function(event){
	if(event.movementX >= 15 && event.movementX >= event.movementY){
		cube.style.transform = 'rotateY(90deg)';
	}else if(event.movementX <= -15 && event.movementX <= event.movementY){
...
document.querySelector('.right').onmouseover = function(event){
	if(event.movementX >= 15 && event.movementX >= event.movementY){
		cube.style.transform = 'rotateY(0deg)';
	}else if(event.movementX <= -15 && event.movementX <= event.movementY){
		cube.style.transform = 'rotateY(-90deg)';
...
document.querySelector('.bottom').onmouseover = function(event){
	if(event.movementX >= 15 && event.movementX >= event.movementY){
		cube.style.transform = 'rotateY(90deg)';
	}else if(event.movementX <= -15 && event.movementX <= event.movementY){
		cube.style.transform = 'rotateY(-90deg)';
...
document.querySelector('.top').onmouseover = function(event){
	if(event.movementX >= 15 && event.movementX >= event.movementY){
		cube.style.transform = 'rotateY(90deg)';
	}else if(event.movementX <= -15 && event.movementX <= event.movementY){
		cube.style.transform = 'rotateY(-90deg)';
